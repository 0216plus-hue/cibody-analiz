...
new_header = """
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6 mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col justify-center items-center text-center">
                            <span class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Genel Ölçüm Kalitesi</span>
...
if old_header in html:
    ...
    with open('/Users/dijimotasarim/Desktop/Server/ai.ayakanaliz.com.tr/frontend/index.html', 'w') as f:
        f.write(html)
    print("index.html ui stats patched.")
else:
    print("Already patched or old header not found.")
